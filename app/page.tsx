            ...
            <div className="space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                ...
                <p className="text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  GutLog is your private, easy-to-use bowel health tracker. Log
                  entries in seconds, visualize trends over time, and generate
                  doctor-ready PDF reports — all designed to help you understand
                  patterns, spot triggers, and have better conversations with
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Comprehensive bowel health tracking with intelligent insights and
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 group hover:bg-slate-50 rounded-xl transition-colors duration-300">
              ...
              <p className="text-slate-600">
                Log bowel movements with Bristol stool type, color, symptoms,
                and notes in seconds with our intuitive interface
              </p>
            </div>
            ...
            <div className="text-center p-6 group hover:bg-slate-50 rounded-xl transition-colors duration-300">
              ...
              <p className="text-slate-600">
                Visualize trends, patterns, and correlations with comprehensive
                charts and 60-day heatmaps
              </p>
            </div>
            ...
            <div className="text-center p-6 group hover:bg-slate-50 rounded-xl transition-colors duration-300">
              ...
              <p className="text-slate-600">
                Your health data is stored exclusively on your device — not on
                our servers. You control what you export or share
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600">
              Beautiful, intuitive design that makes tracking your bowel health
              effortless
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-5 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-slate-300 mb-4 max-w-md">
                Track your bowel health with our comprehensive iOS app. Monitor
                symptoms, track patterns, and get personalized insights for
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="https://habitswarrior.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-slate-300 hover:text-[#ff8000] transition-colors"
                  >
                    Habits Warrior
                  </Link>
                </li>
                <li className="text-slate-400 text-sm">
                  Build lasting habits with gamified tracking
                </li>
              </ul>
            </div>
          </div>
